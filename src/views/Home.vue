<template>
  <div id="app" class="w-screen h-screen antialiased text-gray-800 bg-gray-200">
    ...
    >
      ...
      <!-- buttons -->
      <div
        class="fixed inset-x-0 bottom-0 top-auto inline-flex items-center justify-center"
      >
        <button
          type="button"
          v-if="menu"
          class="w-12 h-12 mx-auto mb-5 transition-all duration-200 bg-gray-800 border-none rounded-full outline-none mx-autoinline-flex focus:outline-none"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
